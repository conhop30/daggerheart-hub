...
// ModeToggle, and whichever of CombatPanel/AdventuringPanel is active
// together, but each of those manages (or is handed) its own state. Ripping
// out and rebuilding any one panel never means touching this file beyond
// the single line that renders it.
  ...
  return (
    <div className="session-view">
      ...
      {session.mode === 'combat' ? (
        ...
        <AdventuringPanel session={session} campaignId={campaignId} onSessionSaved={onSessionSaved} />
      )}
    </div>
  );
}
